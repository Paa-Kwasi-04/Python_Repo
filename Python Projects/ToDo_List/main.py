...
OBJ: list = ['task', 'Due-Date', 'tag', 'completed']  # Fixed: should be list


def menu() -> int:  # Fixed return type
    while True:
        try:
            print(
                "1. Add Task\n"
...
def load_database() -> list:
    ...
    if os.path.exists(FILEPATH):
        ...
        print(f'{FILEPATH} doesn\'t exist, creating new database')
        return []
